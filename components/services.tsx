...
export default function Services() {
  ...
  return (
    <section
      ref={containerRef}
      className="py-32 bg-gradient-to-br from-white via-stone-50 to-teal-50/20 relative overflow-hidden"
    >
      {/* Animated Background */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h2 className="text-5xl md:text-6xl font-serif text-stone-800 mb-8 relative">
            Areas of Focus
            <motion.div
        ...
        <div className="space-y-32 max-w-7xl mx-auto">
          {services.map((service, index) => (
            ...
            >
              <motion.div
                className={`${index % 2 === 1 ? "lg:col-start-2" : ""} space-y-8`}
                whileHover={{ x: index % 2 === 1 ? -10 : 10 }}
                transition={{ duration: 0.3 }}
              >
                <div className="space-y-6">
                  <motion.div
                    className={`inline-flex items-center gap-2 bg-gradient-to-r ${service.color} text-white px-4 py-2 rounded-full text-sm font-medium`}
                    whileHover={{ scale: 1.05 }}
                  >
                    {service.stats}
                  </motion.div>

                  <h3 className="text-4xl md:text-5xl font-serif text-stone-800 leading-tight">{service.title}</h3>

                  <p className="text-lg text-stone-600 leading-relaxed">{service.description}</p>

                  <motion.button
                    className="inline-flex items-center gap-2 text-teal-600 font-semibold text-lg group"
                    whileHover={{ x: 5 }}
              ...
              >
                <div className="relative">
                  ...
                  <div className="relative w-full h-96 lg:h-[450px] rounded-3xl overflow-hidden shadow-2xl">
                    ...
                    <div className="absolute bottom-6 left-6 right-6 z-20">
                      ...
                      >
                        <p className="text-stone-700 font-medium">{service.stats}</p>
                      </motion.div>
                    </div>
                  </div>
                </div>
        ...
        <motion.div
          ...
          className="mt-32"
        >
          <div className="bg-gradient-to-br from-stone-900 to-teal-900 rounded-3xl p-12 max-w-5xl mx-auto relative overflow-hidden">
            {/* Background Pattern */}
            ...
            <div className="relative z-10 text-center text-white">
              ...
              <div className="grid md:grid-cols-2 gap-12">
                {[
                  ...
                  >
                    <h4 className="text-2xl font-semibold mb-4">{item.type}</h4>
                    <p className="text-4xl font-bold text-teal-300 mb-2">{item.price}</p>
